...
import { getSynonyms } from './js/wordsAPI_library';
...
function VocabularyExpanderWordModal({selectedWord, synonymsCache, setSynonymsCache, isModalOpen, handleModalClose}) {
